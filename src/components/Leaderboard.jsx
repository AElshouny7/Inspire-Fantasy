          ...
          <table className="table-auto text-sm">
            <thead>
              <tr className="text-left border-b border-gray-300">
                ...
                <th className="p-2 text-xs md:text-sm">Round 1 (Quarter)</th>
                <th className="p-2 text-xs md:text-sm">Round 2 (Semi)</th>
                <th className="p-2 text-xs md:text-sm">Round Final</th>
              </tr>
            </thead>
            <tbody>
              {sorted.map((user, i) => (
                <tr key={i} className="border-b border-gray-200">
                  ...
                  <td className="p-2 break-words font-bold">
                    {user.totalPoints}
                  </td>
